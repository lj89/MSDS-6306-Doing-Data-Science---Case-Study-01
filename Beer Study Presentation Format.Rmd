...
# applied na.omit since South Dakota didn't have beers with IBUs
medianIBU <- na.omit(aggregate(allBeerDataDF$BitternessUnits, list(allBeerDataDF$State), median, na.rm=TRUE))
...
- *This is an observational study so the analysis is limited to the population of this study.*
