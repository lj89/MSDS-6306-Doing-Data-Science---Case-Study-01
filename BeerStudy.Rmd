...
# create a data frame for number of breweries in each state;
#df=count(breweryDF , "State")

#create a histogram for df above called Figure 1;
#ggplot(data=df, aes(x=State, y = freq)) + 
  #geom_histogram(stat="identity", col="black", aes(fill=freq)) + coord_flip()+ 
  #theme(axis.text.y=element_text(size=6)) + 
  #xlab("State") + ylab("Number of Breweries per State") +
  #geom_text(size=2, aes(label=freq), position=position_dodge(width=1), vjust=0.5) +
